...
TH_All_P = [0.28,0.29,0.30,0.28];
TH_All_R = [0.82,0.73,0.16,0.57];
TH_All_F =[0.40,0.39,0.19,0.36];
...
axis([0.5,3.5,0 ,1]);
hold off;
print(h,'-dpdf','./TH_all2.pdf');
% print(h,'-dpng',[pdfpath,lname,'_',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.png']);
two_alg= {'AMC','AMC-','PR','CS','TCD'};

TH_two_P = [0.30,	0.28,	0.27,	0.25,	0.22];
TH_two_R = [0.57,	0.44,	0.08,	0.63,	0.07];
TH_two_F =[0.35,	0.29,	0.11,	0.32,	0.08];
