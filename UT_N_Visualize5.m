function [precision ,recall,fmeasure,dth] =UT_N_Visualize5(class,Comb)
...
pdfpath = ['./data/UT_TWO_RES_PLOT3/',lname,'/'];
...
%         set(gca, 'DataAspectRatio',[135*v_end(v)/1200*5/(nalg), 1,2]);
    ...
    text(v_end(v)/2,nalg+2.0,[lname,num2str(Comb(v),'%02d')],'FontSize',8,'FontName','Times','HorizontalAlignment','center');
    hold off;
