function [precision ,recall,fmeasure,dth] =HW_All_Visualize4( class,Comb)
...
pdfpath = ['./data/HW_ALL_RES_PLOT2/',lname,'/'];
...
% hold off;
% % print(h,'-dpdf',['./data/HW_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.pdf']);
% %     print(h,'-dpng',['./data/HW_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.png']);
% 
