function [precision ,recall,fmeasure,dth] =TH_N_plot_detection(density_map, class,Comb)
...
% print(h,'-dpdf',['./data/TH_Res_img/',lname,'_',num2str(Comb(1)), num2str(Comb(2)) '.pdf']);
% print(h,'-depsc','-tiff',['./data/TH_Res_img/',lname,'_',num2str(Comb(1)), num2str(Comb(2)) '.eps']);