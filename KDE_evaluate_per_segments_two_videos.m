function KDE_evaluate_per_segments_two_videos(nodesize, classlist, len,vididx)
...
for class =classlist% kiss set has the best results
    ...
    load([dpath,lname,'_nodesize_',num2str(nodesize), '_DENSITY_MAP_KDE_',num2str(len),'_nomask.mat']); %density_map
