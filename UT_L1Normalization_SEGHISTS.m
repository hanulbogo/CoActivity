function UT_L1Normalization_SEGHISTS(nodesize, class, len,flag,NC) % flag =1 ofd flag =2 org
...
%     if~exist([spath,lname,'_nodesize_',num2str(nodesize), '_SEGHISTS_UT_',num2str(len),'_org.mat'],'file')
        UT_make_segments_org(nodesize, class, len,NC);
%     end
...
if flag==2
     save([npath,lname,'_nodesize_',num2str(nodesize), '_DATA_UT_',num2str(len),'L1Norm_org.mat'],'NDATA','TDATA','HOGFDATA','HOGDATA','OFDLDATA','OFDRDATA','OFDTDATA','OFDBDATA','OFDADATA','OFDCDATA','HOFDATA','MBHxDATA','MBHyDATA');
end