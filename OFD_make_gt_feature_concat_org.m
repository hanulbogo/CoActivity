function OFD_make_gt_feature_concat_org(class)
nVideos =25;
...
for i =1:nVideos
    for nc =1:NC
        ...
        Thists=org_Thists;
        HOGFhists=org_HOGFhists;
        HOGhists=org_HOGhists;
        OFDLhists=org_OFDLhists;
        OFDRhists=org_OFDRhists;
        OFDThists=org_OFDThists;
        OFDBhists=org_OFDBhists;
        OFDAhists=org_OFDAhists;
        OFDChists=org_OFDChists;
        HOFhists=org_HOFhists;
        MBHxhists=org_MBHxhists;
        MBHyhists= org_MBHyhists;
...
save([Cpath,ucf_annotation{(class-1)*nVideos+1}.label,'_org.mat'],'THISTS','HOGFHISTS','HOGHISTS','OFDLHISTS','OFDRHISTS','OFDTHISTS','OFDBHISTS','OFDAHISTS','OFDCHISTS','HOFHISTS','MBHxHISTS','MBHyHISTS');