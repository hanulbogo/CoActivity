function [precision ,recall,fmeasure,dth] =UT_All_Visualize2( class,Comb)
...
hold on;
    set(h, 'Position', [1, 1, 600, 200]);
     set(gcf,'PaperSize',[4 2]);
        ...
        set(gcf,'PaperPosition',[-0.2 -0.45 4 3]);
...
%         hold off;
        ...
        nFrame = v_end(v);
                Nkey=5;
                flist=ceil(nFrame/12): ceil(nFrame/6):nFrame;
...
%         end
        ...
        set(gca, 'DataAspectRatio',[50*v_end(v)/1200, 1,2]);
    end
    %     pause;
