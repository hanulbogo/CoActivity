function [precision ,recall,fmeasure,dth] =UCF_All_Visualize4( class,Comb)
load('./data/UCF_nVideos.mat');%nVideolist
nVideos = nVideolist(class);
load('./data/UCF_annotation.mat');
...
pdfpath = ['./data/UCF_ALL_RES_PLOT2/',lname,'/'];
...
%     tmp =zeros(v_end(v),1);
%     gt_start{v} = UCF_annotation{aidx}.gt_start;
%     gt_end{v}= UCF_annotation{aidx}.gt_end;
%     
...
% hold off;
% % print(h,'-dpdf',['./data/UCF_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.pdf']);
% %     print(h,'-dpng',['./data/UCF_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.png']);
% 
