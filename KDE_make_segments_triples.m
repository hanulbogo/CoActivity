function KDE_make_segments_triples(nodesize, classlist, len,vididx)
...
for class =classlist% kiss set has the best results
    ...
    save([spath,ucf_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_SEGHISTS_KDE_',num2str(len),'triples.mat'],'TSEGHISTS','HOGSEGHISTS','HOFSEGHISTS','MBHxSEGHISTS','MBHySEGHISTS');
