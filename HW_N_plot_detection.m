function [precision ,recall,fmeasure,dth] =HW_N_plot_detection(density_map, class,Comb)
...
%     end
%     
%     plot(Comb(v)+density_map{v}/2, v_start(v):v_end(v),'r-');
%     
...
% drawnow();
% 
% print(h,'-dpdf',['./data/HW_Res_img/',lname,'_',num2str(Comb(1)), num2str(Comb(2)) '.pdf']);
% print(h,'-depsc','-tiff',['./data/HW_Res_img/',lname,'_',num2str(Comb(1)), num2str(Comb(2)) '.eps']);