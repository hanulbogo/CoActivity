function KDE_make_segments_all_vid(nodesize, classlist, len,vididx)
...
for class =classlist% kiss set has the best results
    ...
    save([spath,ucf_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_SEGHISTS_KDE_',num2str(len),'_all_videos.mat'],'TSEGHISTS','HOGSEGHISTS','HOFSEGHISTS','MBHxSEGHISTS','MBHySEGHISTS');
