...
all_alg= {'AMC','PR','CS'};
UCF_All_P = [0.61,0.69, 0.507426];
UCF_All_R = [0.68,0.41,0.583564];
UCF_All_F =[0.64,0.51,0.537723];
...
hold off;
print(h,'-dpdf','./UCF_all.pdf');
% print(h,'-dpng',[pdfpath,lname,'_',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.png']);
two_alg= {'AMC','PR','CS','TCD'};

UCF_two_P = [0.63,0.65,0.456576,0.48];
UCF_two_R = [0.55,0.28,0.659033,0.39];
UCF_two_F =[0.57,0.37,0.522486,0.4];
