function OFD_ParzenWindow_gt_org(class,TDATA,HOGFDATA, HOGDATA, OFDLDATA, OFDRDATA, OFDTDATA, OFDBDATA, OFDADATA, OFDCDATA, HOFDATA, MBHxDATA, MBHyDATA,nCenter) %data : N*D
...
if ~exist([dpath, 'Dists_class_',num2str(class),'_',num2str(nCenter),'_org.mat'],'file')
    ...
    save([dpath, 'Dists_class_',num2str(class),'_',num2str(nCenter),'_org.mat'],'dists');
else
    load([dpath, 'Dists_class_',num2str(class),'_',num2str(nCenter),'_org.mat']);
end
