function OFD_make_weight_map(nodesize, classlist, len,density)
...
%     end
    save([dpath,ucf_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_DENSITY_MAP_OFD_',num2str(len),'.mat'],'density_map');
end
