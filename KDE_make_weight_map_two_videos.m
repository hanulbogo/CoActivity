function KDE_make_weight_map_two_videos(nodesize, classlist, len,density,vididx)
...
%             fpos = (n-1)*nodesize+len/2;
    ...
    save([dpath,ucf_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_DENSITY_MAP_KDE_',num2str(len),'_two_videos.mat'],'density_map');
end
