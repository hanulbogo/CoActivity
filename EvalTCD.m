function [precision ,recall,fmeasure] =EvalTCD(class,Comb)
...
pdfpath = ['./data/UT_TWO_RES_IMG/',lname,'/'];
if ~exist(pdfpath,'dir')
    mkdir(pdfpath);
end

load([PFcpath,'TCD_' ,num2str(Comb(1)), '_',num2str(Comb(2)),'.mat'],'pos_frames');
...
%         set(gca,'xtick', flist)
%     end
%     print(h,'-dpdf',['./data/UT_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '_' num2str(Nkey) '.pdf']);
%     print(h,'-dpng',['./data/UT_TWO_RES_IMG/',lname,'/',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '_' num2str(Nkey) '.png']);
%     
%     
%     close all;
