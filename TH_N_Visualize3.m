function [precision ,recall,fmeasure,dth] =TH_N_Visualize3(class,Comb)
...
PFpath ='./data/TH_TWO_POS_Frames/';
PFcpath = [PFpath lname '/'];
pdfpath = ['./data/TH_TWO_RES_PLOT2/',lname,'/'];
...
%     end
    set(gca,'ytick', 0 : 1 :nalg)
     ...
     nFrame = v_end(v);
        ...
        set(gca,'xtick', int32(flist)); 
        set(gca,'xTickLabel', (flist)); 
...
%     print(h,'-depsc',[pdfpath,lname,'_',num2str(Comb(1)), '_',num2str(Comb(2)),'_',num2str(Comb(v)) '.eps']);
