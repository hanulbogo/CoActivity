function density_map=UCF_N_DensityMap(nnodes,nodesize, class, len,density,Comb)
...
%     save([dpath,UCF_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_DENSITY_MAP_UCF_',num2str(len),'_',num2str(nCenter),'_org.mat'],'density_map');
