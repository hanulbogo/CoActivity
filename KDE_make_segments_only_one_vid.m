function KDE_make_segments_only_one_vid(nodesize, classlist, len,vidx)
...
for class =classlist% kiss set has the best results
    ...
    save([spath,ucf_annotation{aidx}.label,'_',num2str(vidx),'_nodesize_',num2str(nodesize), '_SEGHISTS_KDE_',num2str(len),'.mat'],'TSEGHISTS','HOGSEGHISTS','HOFSEGHISTS','MBHxSEGHISTS','MBHySEGHISTS');
