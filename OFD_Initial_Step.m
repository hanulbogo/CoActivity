...
% classlist =47;%1:101;
classlist =[87,47,21,76,6,44,82,64,66,59];

len=80;
NC=7;
nodesize=10;

% if ~exist('./data/validationset.mat','file')
%     classlist =randperm(101);
%     save('./data/validationset.mat','classlist');
% else
%     load('./data/validationset.mat','classlist');
% end
% matlabpool(3);
% parfor class =classlist
