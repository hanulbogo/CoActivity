function UT_make_segments_org(nodesize, classlist, len,NC)
...
for class =classlist% kiss set has the best results
    ...
    save([spath,UT_annotation{aidx}.label,'_nodesize_',num2str(nodesize), '_SEGHISTS_UT_',num2str(len),'_org.mat'],'TSEGHISTS','HOGFSEGHISTS','HOGSEGHISTS','OFDLSEGHISTS','OFDRSEGHISTS','OFDTSEGHISTS','OFDBSEGHISTS','OFDASEGHISTS','OFDCSEGHISTS','HOFSEGHISTS','MBHxSEGHISTS','MBHySEGHISTS');
